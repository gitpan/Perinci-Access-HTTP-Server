...
my @module_files = (
    'Perinci/Access/Base/Patch/PeriAHS.pm',
    'Perinci/Access/HTTP/Server.pm',
    'Plack/Middleware/PeriAHS/CheckAccess.pm',
    'Plack/Middleware/PeriAHS/LogAccess.pm',
    'Plack/Middleware/PeriAHS/ParseRequest.pm',
    'Plack/Middleware/PeriAHS/Respond.pm',
    'Plack/Util/PeriAHS.pm'
);
